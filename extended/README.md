# AI Engineer Roadmap — Extended Version (6-7 Months)

> **This is the extended version** for those who prefer a slower, more thorough pace or have less time per week (10-15 hours). For the accelerated 3-month version, see the [main README](../README.md).
...
**Structure:** 5 phases over ~28 weeks (6-7 months)
...
## Weekly Routine (~12 hours/week)

```
Mon-Tue:     Course material — videos + reading (3 hrs)
Wed:         Hands-on exercises, API experimentation (2 hrs)
Thu-Fri:     Project work (4 hrs)
...
## Comparison: Extended vs Accelerated

| Aspect | Extended (This) | Accelerated (Main README) |
|--------|-----------------|---------------------------|
| Duration | 6-7 months (28 weeks) | 3 months (12 weeks) |
| Hours/week | 10-15 hours | 15-25 hours |
| Pace | Thorough, more review time | Aggressive, building focus |
| Best for | Part-time learners, busy schedules | Full commitment, faster results |

---

> **Note:** This extended version covers the same content as the accelerated plan but with more time for review, practice, and deeper exploration. Choose based on your availability and learning style.
